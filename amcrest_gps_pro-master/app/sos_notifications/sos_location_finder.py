...
# 	geolocator = Nominatim(user_agent="amcrest_harsh")
# 	try:
...
def get_location(longitude, latitude):
	...
	if check_location.text != 'NONE' or check_location.text != '':
		...
		response = requests.get("https://maps.googleapis.com/maps/api/geocode/json?latlng="+latitude+","+longitude+"&key="+get_google_keys())
