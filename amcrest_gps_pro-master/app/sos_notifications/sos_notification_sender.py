...
def send_notification(imei, message_title, message_body, customer_id, report, event_type=None, global_notifcation=False):
	if report.get('send_notification') and global_notifcation:
