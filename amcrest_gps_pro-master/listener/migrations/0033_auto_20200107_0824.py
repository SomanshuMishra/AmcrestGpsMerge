# Generated by Django 2.1.4 on 2020-01-07 08:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('listener', '0032_auto_20200102_0814'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='speedalertobd',
            index=models.Index(fields=['date', 'imei', 'device_name', 'longitude', 'latitude', 'gps_utc_time', 'send_time', 'protocol', 'record_date'], name='speed_alert_date_3df343_idx'),
        ),
    ]
